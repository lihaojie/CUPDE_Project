...
public class DailyTaskToggle : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        mImage = mBackgroundPanel.transform.Find("GameObject/Image").GetComponent<Image>();
    ...
    public void IsOn(bool isOn)
    {
        ...
        var texture2D = mResLoader.LoadSync<Texture2D>( !isOn?"ic_dailyTask":"ic_dailyTaskSel");
